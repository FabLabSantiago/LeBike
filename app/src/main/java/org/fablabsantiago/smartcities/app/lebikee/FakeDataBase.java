    ...
    public static Destination createDestinationObject(String name, String displayName)
    {
        ...
        switch(name)
        {
            case "casa":
                ...
                destination.addPositiveHotspot(new LatLng(-33.436836, -70.610898), "Ciclovía", "Ciclovía en  buen estado");
                destination.addPositiveHotspot(new LatLng(-33.415570, -70.599686), "Bien", "Todo tranquilo :).");
                destination.addNegativeHotspot(new LatLng(-33.439271, -70.621557), "Cruce Peligroso", "Se cruzan autos por al frente.");
                destination.addNegativeHotspot(new LatLng(-33.432028, -70.602107), "Autos Asesinos", "Pasan muy rápido y la calle es angosta.");
                break;
            case "beauchef850":
                Log.i("FakeDataBase","switch case 'beauchef850'");
                destination = new Destination(name, displayName, new LatLng(-33.4577491, -70.6634021));
                destination.addPositiveHotspot(new LatLng(-33.450757, -70.645864), "Ciclovía", "Buena ciclovía, rápida.");
                destination.addNegativeHotspot(new LatLng(-33.452959, -70.657371), "Cruce Peligroso", "Mucho auto y poca señalización.");
                destination.addNegativeHotspot(new LatLng(-33.448725, -70.637259), "Vía en mal estado", "La ciclovía esta rota con grandes baches en ciertos lugares.");
                break;
